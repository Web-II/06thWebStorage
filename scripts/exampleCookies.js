...
function init() {
  ...
  // Dit kan je ook zien.
  document.cookie =
    'adblock_status=noactive; expires=Thu, 18 Dec 2022 12:00:00 UTC';
  ...
  document.cookie =
    'language=NL; expires=Thu, 18 Dec 2022 12:00:00 UTC; path=/';

  // Een cookie veranderen kan als volgt
  document.cookie =
    'language=FR; expires=Thu, 18 Dec 2020 12:00:00 UTC; path=/';
